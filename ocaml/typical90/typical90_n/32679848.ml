...
//##// Submitted: 2022-06-23 16:25:37 +0000 UTC ( https://atcoder.jp/contests/typical90/submissions/32679848 ) 
...
let () = fold2_exn aa bb ~init:0 ~f:(fun acc a b -> acc + Int.abs (a - b)) |> pi
