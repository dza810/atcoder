...
//##// Submitted: 2023-01-09 05:40:04 +0000 UTC ( https://atcoder.jp/contests/typical90/submissions/37897341 ) 
...
let rec loop l r x =
  ...
  else if x < target then loop l (r + 1) (x + aa.(r))
  else loop (l + 1) r (x - aa.(l))

let () =
  print_endline (if loop 0 1 aa.(0) then "Yes" else "No");