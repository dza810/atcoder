...
//##// Submitted: 2023-02-04 07:24:25 +0000 UTC ( https://atcoder.jp/contests/abc277/submissions/38587880 ) 
...
let dijistra () =
  ...
  let rec aux q =
    ...
    | Some (q, (_, v)) ->
      ...
      in
      let q =
        Hashtbl.find_multi graph i
        |> List.filter ~f:(fun j -> ISet.mem sw (Hashtbl.find_exn a (i, j)))
