...
//##// Submitted: 2023-01-15 12:03:07 +0000 UTC ( https://atcoder.jp/contests/abc285/submissions/38043836 ) 
...
let () =
  let a, b = (Int.max a b, Int.min a b) in
  ps @@ if a / 2 = b then "Yes" else "No"
