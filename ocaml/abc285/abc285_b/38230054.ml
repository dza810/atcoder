...
//##// Submitted: 2023-01-21 14:03:52 +0000 UTC ( https://atcoder.jp/contests/abc285/submissions/38230054 ) 
...
let () =
  (1 -- (nn - 1)) (fun i ->
      ...
      match
        1 -- (nn - i)
        |> find_pred ~f:(fun k -> Char.(str.(k - 1) = str.(k + i - 1)))
      with
      | None -> nn - i
      | Some v -> v - 1)
