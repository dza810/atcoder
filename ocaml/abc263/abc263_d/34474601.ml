...
//##// Submitted: 2022-08-31 09:07:02 +0000 UTC ( https://atcoder.jp/contests/abc263/submissions/34474601 ) 
...
let rec dp p t =
  Hashtbl.find_or_add dptbl (p, t) ~default:(fun () ->
      ...
      then 0
        ...
        | 0 ->
          let v1 = ll * p in
          let v2 = Int.min (dp (p - 1) 0) (dp (p - 1) 1) + aa.(p) in
          Int.min v1 v2
        | 1 ->
          let v1 = Int.min (dp (p - 1) 0) (dp (p - 1) 1) in
          v1 + aa.(p)
